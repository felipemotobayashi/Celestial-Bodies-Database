...
INSERT INTO public.constellation VALUES (5, 'Centarus', NULL, 'Centaur', 5);
INSERT INTO public.constellation VALUES (6, 'Cetus', NULL, 'Sea monster', 9);
INSERT INTO public.constellation VALUES (7, 'Coma Berenices', 1536, 'Berenices hairs', 6);
...
INSERT INTO public.galaxy VALUES (1, 'Backward Galaxy', 'Its seems to rotate in the opposite direction to what it should according to its shape.', false, 5);
...
INSERT INTO public.galaxy VALUES (10, 'Little Sombrero Galaxy', 'Its looks a sombrero, but its smaller than the Sombrero Galaxy.', false, 10);
...
INSERT INTO public.moon VALUES (3, 'Deimos', 1877, 23, 4);
INSERT INTO public.moon VALUES (4, 'Io', 1877, 13, 4);
INSERT INTO public.moon VALUES (5, 'Europa', 1610, 3138, 5);
INSERT INTO public.moon VALUES (6, 'Ganymede', 1610, 4800, 5);
...
INSERT INTO public.moon VALUES (12, 'Enceladus', 1789, 394, 6);
...
INSERT INTO public.planet VALUES (1, 'Mercury', 0.24, 58.65, false, 7);
...
INSERT INTO public.star VALUES (5, 'Rigil Kentarus', 4.36, 0.01, '2016-11-06', 11);
...
SELECT pg_catalog.setval('public.constallation_constellation_id_seq', 13, true);
...
SELECT pg_catalog.setval('public.moon_mood_id_seq', 23, true);
...
--
-- Name: constellation constallation_star_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.constellation
    ADD CONSTRAINT constallation_star_id_fkey FOREIGN KEY (star_id) REFERENCES public.star(star_id);
